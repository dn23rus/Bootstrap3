 ...
 */(function(e) {
    ...
    var n = function(n, o) {
        ...
        var m = a.parent(), g = a.siblings("." + o.classHandle), y = a.siblings("." + o.classLabelOff), b = y.children("span"), w = a.siblings("." + o.classLabelOn), S = w.children("span");
        if (o.resizeHandle || o.resizeContainer) {
            c.onspan = S.outerWidth();
        ...
        var x = c.container - c.handle - 6, T = function(e) {
            var t = a[0].checked, n = t ? x : 0, e = arguments.length > 0 ? arguments[0] : !0;
            if (e && o.enableFx) {
                g.stop().animate({
                    left: n
                }, o.duration, o.easing);
        ...
        o.enableDrag && e(document).bind("mousemove.iButton_" + f + " touchmove.iButton_" + f, function(e) {
            ...
            var n = Math.min(1, Math.max(0, (t - p.offset) / x));
            g.css("left", n * x);
            w.css("width", n * x + 4);
            b.css("marginRight", -n * x);
            S.css("marginLeft", -(1 - n) * x);
            return !1;
        });
        e(document).bind("mouseup.iButton_" + f + " touchend.iButton_" + f, function(t) {
            ...
            if (!h.dragging || (new Date).getTime() - p.time < o.clickOffset) {
                ...
                var i = N(t), s = (i - p.offset) / x, r = s >= .5;
                a[0].checked == r && (n = !1);
                a.attr("checked", r);
            }
